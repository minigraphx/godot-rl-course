...
| Phase | Units | You do |
|-------|-------|--------|
| Explore | 0–2 | Run and tweak pre-built agents with the Godot editor open |
| Scale | 3–8 | Train headless, parallelize rollouts, add memory |
| Ship | 9–10 | Export to ONNX, run inference in-game, optional web/WASM |
...
- [Unit 2 — Lunar Lander Build](unit-02.md)
