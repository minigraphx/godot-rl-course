...
??? success "Self-check answers"
    ...
    4. The course-default protocol: at least **3 seeds** (Section 5), roughly 50 evaluation episodes per seed against a random-policy baseline, reported as mean ± std plus the **IQM** (Section 6). Deterministic or stochastic is your call — just state which one in your report and keep it consistent across seeds.
